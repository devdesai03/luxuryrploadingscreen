...
Config.Socials = [
    {
        name: "discord",
        label: "Discord",
        description: "Click here to join our Discord server!",
        icon: "assets/media/icons/discord.png",
        link: "https://discord.gg/luxuryrp",    // change this to your own discord server link 
    },
    {
        name: "tebex",
        label: "Donations",
        description:
            "Click here to checkout our Tebex",
        icon: "assets/media/icons/tebex.png",
        link: "luxrp.tebex.io",                // change this to your own tebex link
    },
];
